...
### Knowledge Graph Query Context Wrapper
...
# Nanobot Initial Setup Prompting Templates

Create a folder of markdown fills for example Personalities/ and Skills/ and a folder for Memory/
