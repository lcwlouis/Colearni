...
export const metadata: Metadata = {
  title: "Privacy Policy · Colearni",
  description: "Privacy Policy for Colearni (draft placeholder).",
};
    ...
    <div className="mx-auto w-full max-w-2xl px-5 py-16 sm:px-8 md:py-28">
      ...
      <div className="mt-8 rounded-xl border border-[var(--mk-border)] bg-[var(--mk-bg-soft)] p-6">
        ...
        <p className="mt-3 text-base leading-7 text-[var(--mk-muted)]">
          Colearni is still in active development, and our Privacy Policy has not
          been finalised. This page is a placeholder so the rest of the site can
          link to it. A full description of what we collect and how we handle
          your data will appear here before any public launch.
        </p>
        <p className="mt-3 text-base leading-7 text-[var(--mk-muted)]">
