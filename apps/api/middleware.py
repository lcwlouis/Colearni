...
class CorrelationIdMiddleware(BaseHTTPMiddleware):
    ...
    returned in the response headers.  Logs request/response summary.

    AI-domain spans (chat, retrieval, LLM, graph) create their own root
    spans; generic HTTP spans are intentionally excluded from Phoenix to
    keep the trace surface focused on AI debugging.
    """
