...
from domain.learning.quiz_generation import (
    ...
    extract_context_keywords as _extract_context_keywords,
    ...
    *,
    ...
    with observation_context(
        ...
        try:
            ...
            if isinstance(exc, _QVE) and not isinstance(exc, LevelUpQuizValidationError):
                raise LevelUpQuizValidationError(str(exc)) from exc
            if isinstance(exc, _QGE) and not isinstance(exc, LevelUpQuizGradingError):
                raise LevelUpQuizGradingError(str(exc)) from exc
            raise
    ...
    *,
    ...
    for attempt in range(1, MAX_GENERATION_ATTEMPTS + 1):
        ...
        try:
            ...
            return normalized
        except (LevelUpQuizValidationError, _QVE) as exc:
